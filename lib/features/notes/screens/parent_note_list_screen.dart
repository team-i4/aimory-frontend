...
class ParentNoteListScreen extends StatefulWidget {
  ...
  _ParentNoteListScreenState createState() => _ParentNoteListScreenState();
}

class _ParentNoteListScreenState extends State<ParentNoteListScreen> {
  // Note 데이터 리스트 생성
                ...
                return GestureDetector(
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            ParentNoteDetailScreen(note: items[index]), // 데이터 전달
                      ),
                    );
                  },
                  child : Container(
